...
public interface MoListener {
     ...
     */
    void onBufferingEvent(float percentage);
     ...
     */
    void onPlayTimeEvent(long time);

    /**
     *
     * @param width video new width (before rotating)
     * @param height video new height (before rotating)
     * @param rotation video rotation. NOTE that this value does NOT affect to width and height.
     */
    void onVideoSizeChangedEvent(int width, int height, int rotation);
